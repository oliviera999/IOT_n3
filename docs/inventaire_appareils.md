...
|-------------|------------------|-------|---------------------|------------------|------------------|------|
| n3-n3pp-01 | n3pp4_2 | ESP32 (esp32dev) | Serre / aquaponie | `/n3pp/n3ppdatas/post-n3pp-data.php` (board=3) | 4.13 | API key POST |
| n3-msp-01 | msp2_5 | ESP32 (esp32dev) | Station météo extérieure | `/msp1/msp1datas/post-msp1-data.php` (board=2) | 2.13 | API key POST |
