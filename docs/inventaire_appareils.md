...
|-------------|------------------|-------|---------------------|------------------|------------------|------|
| n3-n3pp-01 | n3pp | ESP32 (esp32dev) | Serre / aquaponie | `/n3pp/n3ppdatas/post-n3pp-data.php` (board=3) ou `/n3pp/post-data` | 4.38 | API key POST ou HMAC-SHA256 |
| n3-msp-01 | msp | ESP32 (esp32dev) | Station météo extérieure | `/msp1/msp1datas/post-msp1-data.php` (board=2) ou `/msp1/post-data` | 2.42 | API key POST ou HMAC-SHA256 |
