...
|-------------|------------------|-------|---------------------|------------------|------------------|------|
| n3-n3pp-01 | n3pp | ESP32 (esp32dev) | Serre / aquaponie | `/n3pp/n3ppdatas/post-n3pp-data.php` (board=3) | 4.15 | API key POST |
| n3-msp-01 | msp | ESP32 (esp32dev) | Station météo extérieure | `/msp1/msp1datas/post-msp1-data.php` (board=2) | 2.15 | API key POST |
