...
|-------------|------------------|-------|---------------------|------------------|------------------|------|
| n3-n3pp-01 | n3pp | ESP32 (esp32dev) | Serre / aquaponie | `/n3pp/n3ppdatas/post-n3pp-data.php` (board=3) | 4.20 | API key POST |
| n3-msp-01 | msp | ESP32 (esp32dev) | Station météo extérieure | `/msp1/msp1datas/post-msp1-data.php` (board=2) | 2.40 | API key POST |
...
| n3-cam-msp-01 | uploadphotosserver (msp1) | ESP32-CAM | Station météo | `/msp1gallery/upload.php` | 2.11 | X-Api-Key header |
| n3-cam-n3pp-01 | uploadphotosserver (n3pp) | ESP32-CAM | Serre | `/n3ppgallery/upload.php` | 2.11 | X-Api-Key header |
| n3-cam-ffp3-01 | uploadphotosserver (ffp3) | ESP32-CAM | Aquaponie | `/ffp3/ffp3gallery/upload.php` | 2.11 | X-Api-Key header |

Note: le firmware caméra envoie bien `X-Api-Key`. La validation côté serveur est documentée comme point de vigilance dans `docs/audit_firmware_camera_2026-03.md` (écarts connus selon endpoint).
