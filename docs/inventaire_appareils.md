...
| n3-cam-msp-01 | uploadphotosserver (msp1) | ESP32-CAM | Station météo | `/msp1gallery/upload.php` | 2.8 | X-Api-Key header |
| n3-cam-n3pp-01 | uploadphotosserver (n3pp) | ESP32-CAM | Serre | `/n3ppgallery/upload.php` | 2.8 | X-Api-Key header |
| n3-cam-ffp3-01 | uploadphotosserver (ffp3) | ESP32-CAM | Aquaponie | `/ffp3/ffp3gallery/upload.php` | 2.8 | X-Api-Key header |
