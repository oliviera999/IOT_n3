...
|----------|--------|-------------------|------|
| **n3pp4_2** | ESP32 | `/n3pp/n3ppdatas/post-n3pp-data.php`, `/n3pp/n3ppcontrol/n3pp-outputs-action.php` | Données serre, contrôle sorties |
| **msp2_5** | ESP32 | `/msp1/msp1datas/post-msp1-data.php`, `/msp1/msp1control/msp1-outputs-action.php` | Données météo, contrôle sorties |
...
| Critère | n3pp4_2 | msp2_5 | ffp5cs | uploadphotosserver | uploadphotosserver_ffp3_1_5 |
|---------|---------|--------|--------|-------------------|----------------------------|
...
- **n3pp4_2, msp2_5** : OTA HTTP distant via n3_ota (metadata.json + firmware.bin). URLs prod/test.
...
|----------------|---------|--------------------|
| ~~msp2_5 : DHT isnan sans fallback~~ | ~~Majeur~~ | **Corrigé** — fallback 20°C / 50 % en cas de NaN |
...
- Firmwares : `firmwires/n3pp4_2/`, `firmwires/msp2_5/`, `firmwires/uploadphotosserver/`, `firmwires/ffp5cs/`, `firmwires/uploadphotosserver_ffp3_1_5_deppsleep/`
