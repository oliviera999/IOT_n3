...
- **firmwires/** est un **sous-module** pointant vers **n3_firmwires** (firmwares : n3pp, msp, uploadphotosserver*, poissonglouton, ffp5cs ; `ratata` et `LVGL_Widgets` sont rangés sous `firmwires/à voir/`). ffp5cs n’est plus un submodule à la racine ; il est un dossier normal dans n3_firmwires.
